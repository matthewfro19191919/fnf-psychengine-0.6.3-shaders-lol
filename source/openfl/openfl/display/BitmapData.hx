...
class BitmapData implements IBitmapDrawable
{
	...
	**/
	...
	/**
		...
		**Note:** The `drawWithQuality()` method works exactly like the `draw()` method,
		...
		@param	blendMode	A string value, from the openfl.display.BlendMode class,
	...
	**/
	...
	/**
		...
		openfl.display.PNGEncoderOptions, openfl.display.JPEGEncoderOptions, and
		openfl.display.JPEGXREncoderOptions.
